...
install_utilities() {
    ...
    install_packages kanata antimicrox coolercontrol-bin wf-recorder localsend gpu-screen-recorder mpv mpv-mpris kdeconnect      # fusermount is provided by fuse2/fuse3, so removed redundant entry
}
